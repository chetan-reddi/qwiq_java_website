...
public class EmailService {
	...
	public void sendOTP(String recipient, String secretKey) throws IOException, SendOTPFailed {
		...
		MimeMessagePreparator messagePreparator = mimeMessage -> {
			...
			String content = mailContentBuilder.transitOtpbuild(secretKey, recipient);
...
public void sendTransitOTP(String recipient, String secretKey) throws IOException, SendOTPFailed {
		...
		MimeMessagePreparator messagePreparator = mimeMessage -> {
			...
			messageHelper.setFrom("support@blurover.com");
			messageHelper.setTo(recipient);
			messageHelper.setSubject("Transit OTP");
			String content = mailContentBuilder.transitOtpbuild(secretKey, recipient);
			messageHelper.setText(content, true);
		};
		try {
