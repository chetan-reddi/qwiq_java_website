...
public class MailContentBuilder {
	...
	public String transitOtpbuild(String secretKey, String recipient) {
		
		Context context = new Context();
		context.setVariable("secretKey", secretKey);
		return templateEngine.process(new ClassPathResource("transitotpmailtemplate").getPath(), context);
	}
}
